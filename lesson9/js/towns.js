    ...
    .then(function(jsonObject) {
        ...
        for (let i = 0; i < towns.length; i++) {
            ...
            if (towns[i].name == "Preston" || towns[i].name == "Fish Haven" || towns[i].name == "Soda Springs") {
                ...
                if (towns[i].name == "Preston") {image.setAttribute("src", "images/preston.jpg")}
                if (towns[i].name == "Fish Haven") {image.setAttribute("src", "images/fishhaven.jpg")}
                if (towns[i].name == "Soda Springs") {image.setAttribute("src", "images/sodasprings.jpg")}
